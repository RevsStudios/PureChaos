...
@OnlyIn(Dist.CLIENT)
public class MeganiumBobberProjectileRenderer extends EntityRenderer<MeganiumFishingBobberEntity> {
	...
	public MeganiumBobberProjectileRenderer(EntityRendererManager manager) {
		super(manager);
	}

	public void render(@Nonnull MeganiumFishingBobberEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
	...
	public ResourceLocation getEntityTexture(MeganiumFishingBobberEntity entity) {
		return BOBBER;
	}

	public ResourceLocation getTextureLocation(MeganiumFishingBobberEntity p_110775_1_) {
		return BOBBER;
	}
}
