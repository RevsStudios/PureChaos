...
public class PCConfiguredFeatures {
	...
	public static final ConfiguredFeature<?, ?> ORE_GALACTITE = register("ore_galactite", Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, States.GALACTITE_ORE, 3)).decorated(Placement.DEPTH_AVERAGE.configured(new DepthAverageConfig(1, 40))).squared().count(1));
	...
	public static final ConfiguredFeature<?, ?> MINING_ORE_GALACTITE = register("mining_ore_galactite", Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, States.GALACTITE_ORE, 3)).decorated(Placement.DEPTH_AVERAGE.configured(new DepthAverageConfig(1, 20))).squared().count(1));
