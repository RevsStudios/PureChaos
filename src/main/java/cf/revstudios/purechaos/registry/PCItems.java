...
public class PCItems {
    ...
    public static final RegistryObject<Item> GALACTITE_DUST = ITEMS.register("galactite_dust", () -> new Item(new Item.Properties().tab(CAItemGroups.ITEMS)));
    public static final RegistryObject<Item> GALACTITE = ITEMS.register("galactite", () -> new Item(new Item.Properties().tab(CAItemGroups.ITEMS)));
    public static final RegistryObject<Item> GALACTITE_ROD = ITEMS.register("galactite_rod", () -> new Item(new Item.Properties().tab(CAItemGroups.ITEMS)));
    ...
    public static final RegistryObject<EnchantedShovelItem> MEGANIUM_SHOVEL = ITEMS.register("meganium_shovel", () -> new EnchantedShovelItem(PCItemTier.TOOL_MEGANIUM, PCConfig.COMMON.meganiumShovelDamage.get() - 47, -3F, new Item.Properties().rarity(RARITY_MEGANIUM).tab(CAItemGroups.EQUIPMENT),
            new EnchantmentData[]{new EnchantmentData(Enchantments.BLOCK_EFFICIENCY, 5), new EnchantmentData(Enchantments.UNBREAKING, 3)}));
    public static final RegistryObject<EnchantedPickaxeItem> MEGANIUM_PICKAXE = ITEMS.register("meganium_pickaxe", () -> new EnchantedPickaxeItem(PCItemTier.TOOL_MEGANIUM, PCConfig.COMMON.meganiumPickaxeDamage.get() - 47, -2.8F, new Item.Properties().rarity(RARITY_MEGANIUM).tab(CAItemGroups.EQUIPMENT),
    ...
    public static final RegistryObject<EnchantedAxeItem> MEGANIUM_AXE = ITEMS.register("meganium_axe", () -> new EnchantedAxeItem(PCItemTier.TOOL_MEGANIUM, PCConfig.COMMON.meganiumAxeDamage.get() - 47, -3F, new Item.Properties().rarity(RARITY_MEGANIUM).tab(CAItemGroups.EQUIPMENT),
            new EnchantmentData[]{new EnchantmentData(Enchantments.BLOCK_EFFICIENCY, 5), new EnchantmentData(Enchantments.UNBREAKING, 3)}));
    public static final RegistryObject<EnchantedHoeItem> MEGANIUM_HOE = ITEMS.register("meganium_hoe", () -> new EnchantedHoeItem(PCItemTier.TOOL_MEGANIUM, PCConfig.COMMON.meganiumHoeDamage.get() - 47, 0F, new Item.Properties().rarity(RARITY_MEGANIUM).tab(CAItemGroups.EQUIPMENT),
            new EnchantmentData[]{new EnchantmentData(Enchantments.BLOCK_EFFICIENCY, 5), new EnchantmentData(Enchantments.BLOCK_FORTUNE, 3), new EnchantmentData(Enchantments.UNBREAKING, 3)}));
