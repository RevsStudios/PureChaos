...
import cf.revstudios.purechaos.items.*;
...
public class PCItems {
	...
	public static final RegistryObject<MeganiumSwordItem> MEGANIUM_SWORD = ITEMS.register("meganium_sword", () -> new MeganiumSwordItem(PCItemTier.TOOL_MEGANIUM, () -> PCServerConfig.SERVER.meganiumSwordDamage, -2.4F, new Item.Properties().rarity(RARITY_MEGANIUM).tab(CAItemGroups.EQUIPMENT),
	...
	public static final RegistryObject<MeganiumShovelItem> MEGANIUM_SHOVEL = ITEMS.register("meganium_shovel", () -> new MeganiumShovelItem(PCItemTier.TOOL_MEGANIUM, () -> PCServerConfig.SERVER.meganiumShovelDamage, -3F, new Item.Properties().rarity(RARITY_MEGANIUM).tab(CAItemGroups.EQUIPMENT),
			() -> new EnchantmentData[]{new EnchantmentData(Enchantments.BLOCK_EFFICIENCY, 5), new EnchantmentData(Enchantments.UNBREAKING, 3)}));
	public static final RegistryObject<MeganiumPickaxeItem> MEGANIUM_PICKAXE = ITEMS.register("meganium_pickaxe", () -> new MeganiumPickaxeItem(PCItemTier.TOOL_MEGANIUM, () -> PCServerConfig.SERVER.meganiumPickaxeDamage, -2.8F, new Item.Properties().rarity(RARITY_MEGANIUM).tab(CAItemGroups.EQUIPMENT),
	...
	public static final RegistryObject<MeganiumAxeItem> MEGANIUM_AXE = ITEMS.register("meganium_axe", () -> new MeganiumAxeItem(PCItemTier.TOOL_MEGANIUM, () -> PCServerConfig.SERVER.meganiumAxeDamage, -3F, new Item.Properties().rarity(RARITY_MEGANIUM).tab(CAItemGroups.EQUIPMENT),
			() -> new EnchantmentData[]{new EnchantmentData(Enchantments.BLOCK_EFFICIENCY, 5), new EnchantmentData(Enchantments.UNBREAKING, 3)}));
	public static final RegistryObject<MeganiumHoeItem> MEGANIUM_HOE = ITEMS.register("meganium_hoe", () -> new MeganiumHoeItem(PCItemTier.TOOL_MEGANIUM, () -> PCServerConfig.SERVER.meganiumHoeDamage, 0F, new Item.Properties().rarity(RARITY_MEGANIUM).tab(CAItemGroups.EQUIPMENT),
			() -> new EnchantmentData[]{new EnchantmentData(Enchantments.BLOCK_EFFICIENCY, 5), new EnchantmentData(Enchantments.BLOCK_FORTUNE, 3), new EnchantmentData(Enchantments.UNBREAKING, 3)}));
	...
	public static final RegistryObject<MeganiumBattleAxeItem> MEGANIUM_BATTLE_AXE = ITEMS.register("meganium_battle_axe", () -> new MeganiumBattleAxeItem(PCItemTier.TOOL_MEGANIUM, () -> PCServerConfig.SERVER.meganiumBattleAxeDamage, -3.35F, 3.5D, new Item.Properties().rarity(RARITY_MEGANIUM).tab(CAItemGroups.EQUIPMENT),
